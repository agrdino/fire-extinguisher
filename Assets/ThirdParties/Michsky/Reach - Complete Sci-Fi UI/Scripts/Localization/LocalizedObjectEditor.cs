    ...
    public class LocalizedObjectEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (loTarget.localizationSettings == null)
            {
                ...
                try { loTarget.localizationManager = FindObjectsByType<LocalizationManager>(FindObjectsSortMode.None)[0]; } catch { }
#else
        ...
        {
            ReachUIEditorHandler.DrawComponentHeader(customSkin, "TopHeader_Localization");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    ReachUIEditorHandler.DrawProperty(localizationManager, customSkin, "Manager");
                    if (loTarget.localizationManager != null) { GUI.enabled = false; }
                    ReachUIEditorHandler.DrawProperty(localizationSettings, customSkin, "Settings");
                    GUI.enabled = true;
                    ...
                    {
                        ReachUIEditorHandler.DrawProperty(audioObj, customSkin, "Audio Source");
                    }

                    else if (loTarget.objectType == LocalizedObject.ObjectType.Image)
                    {
                        ReachUIEditorHandler.DrawProperty(imageObj, customSkin, "Image Object");
                    }
                    ...
                    {
                        ReachUIEditorHandler.DrawHeader(customSkin, "Header_Tables", 10);
                ...
                case 1:
                    ...
                    rebuildLayoutOnUpdate.boolValue = ReachUIEditorHandler.DrawToggle(rebuildLayoutOnUpdate.boolValue, customSkin, "Rebuild Layout On Update", "Force to rebuild layout on item update to prevent visual glitches.");
                    forceAddToManager.boolValue = ReachUIEditorHandler.DrawToggle(forceAddToManager.boolValue, customSkin, "Force Add To Manager", "Force to add this component to the manager on awake.");
                    break;
            }
